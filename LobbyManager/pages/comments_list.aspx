<%@ Page Title="" Language="C#" MasterPageFile="~/masters/Main.Master" AutoEventWireup="true" CodeBehind="comments_list.aspx.cs" Inherits="LobbyManager.pages.comments_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainHolder" runat="server">
    <form role="form" runat="server">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Histórico de Comentarios</h1>
            </div>
        </div>
