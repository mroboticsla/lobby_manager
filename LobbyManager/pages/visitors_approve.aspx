...
<asp:Content ID="Content2" ContentPlaceHolderID="MainHolder" runat="server">
    <form role="form" runat="server">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Vistante N°<%= visitorID.ToString().ToLower() %></h1>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <fieldset id="fs_visitDetails" runat="server">
                                    ...
                                    <asp:Button runat="server" class="btn btn-success" OnClick="UpdateVisitor" Text="Iniciar Visita"></asp:Button>
                                    <button type="reset" class="btn btn-default" onclick="returnToList();">Cancelar</button>
                                </fieldset>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="panel-body">
                                <fieldset id="Fieldset1" runat="server">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input runat="server" id="Text1" class="form-control" placeholder="Código de Empleado" />
                                    </div>
                                </fieldset>
                            </div>
                        </div>
