<%@ Page Title="" Language="C#" MasterPageFile="~/masters/Mobile.Master" AutoEventWireup="true" CodeBehind="equipment_mobile.aspx.cs" Inherits="LobbyManager.pages.equipment_mobile" %>
    ...
    <script>
        ...
        function finishProc() {
            if ((<%= approved.ToString().ToLower() %>))
            {
                ...
                window.location="visitors_mobile.aspx?finish=true";
            }
